                ...
                <div className="w-full max-w-xl mx-auto mb-8">
                     {!isKeyReady ? (
                        <div className="flex flex-col space-y-2">
                            ...
                            <p className="text-xs text-gem-offwhite/50">or <button onClick={onOpenSettings} className="underline hover:text-gem-blue">enter manually in settings</button></p>
                        </div>
                    ) : (
                        <div className="w-full bg-gem-slate border border-gem-mist/50 rounded-lg py-3 px-5 text-center text-gem-teal font-semibold flex justify-center items-center relative">
                ...
                <div className="w-full max-w-xl mx-auto">
                    {files.length > 0 && (
                        <button 
                            ...
                            title={!isKeyReady ? "Please select an API key first" : "Start chat session with the selected files"}
                        >
                            Upload and Chat
                        </button>
                    )}
